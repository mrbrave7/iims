        ...
        <div className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`pl-10 outline-none w-full rounded-lg border ${singleCourseModuleError.moduleTitle
                      ? "border-red-500"
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`pl-10 outline-none w-full rounded-lg border ${singleCourseModuleError.moduleDurationInDays
                      ? "border-red-500"
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`pl-10 outline-none w-full rounded-lg border ${singleCourseModuleError.moduleBannerUrl
                      ? "border-red-500"
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`pl-10 outline-none w-full rounded-lg border ${singleCourseModuleError.order
                      ? "border-red-500"
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              className={`w-full rounded-lg border ${singleCourseModuleError.moduleDescription
                  ? "border-red-500"
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className={`pl-10 outline-none w-full rounded-lg border ${singleCourseModuleError.moduleLearningObjectives
                      ? "border-red-500"
                      : learningObjective
                        ? "border-orange-500"
                        : "border-stone-300 dark:border-stone-700"
            ...
            <div className="flex mt-4 gap-4 flex-wrap">
              {singleCourseModule.moduleLearningObjectives.map((objective, index) => (
                <span
                  key={index}
                  className="flex gap-2 px-3 py-1 text-orange-600 rounded text-lg font-bold bg-stone-500/50"
                >
                  <p>{objective}</p>
                  <button
                    type="button"
        ...
        <div className="flex flex-col gap-2">
          ...
          <ul className="space-y-2">
            {modules.map((module, index) => (
              <li
                key={index}
                className="w-full text-orange-600 rounded flex items-center justify-between p-2 shadow-sm shadow-stone-500"
              >
                <div>
                  <p>
